...
export class AppComponent implements OnInit {
  ...
  numbers = [
    { id: 1, name: 'one', disabled: false },
    { id: 2, name: 'two', disabled: false },
    { id: 3, name: 'three', disabled: false },
    { id: 4, name: 'four', disabled: false },
  ];

  onChange(evnt) {
    console.log(evnt);
    let id = evnt.id;
    let oobj = this.numbers.findIndex((obj) => obj.id == id);

    this.numbers[oobj].disabled = true;
  }
